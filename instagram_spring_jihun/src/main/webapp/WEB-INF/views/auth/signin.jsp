...
<head>
    ...
    <link rel="stylesheet" href="/jihun/static/css/auth.css">
...
<body>
                ...
                <div class="r-content">
                    <div class="item-box">
                        ...
                        <div class="items-group">
                            <form action="/jihun/auth/signin" method="post" class="items-group-form">
    ...
    <script src="/jihun/static/js/auth.js"></script>
</body>
