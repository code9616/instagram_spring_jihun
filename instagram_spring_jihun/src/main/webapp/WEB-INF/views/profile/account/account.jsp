                    ...
                    <section class="profile-box">
                        ...
                        <form class="profile-box-form2">
                            <div class="box-items">    
                                ...
                                <div class="box-item-right">
                                    <div class="input-items">
                                        <input type="text" id="name" class="text-input" name="name" value="김지훈">
                            ...
                            <div class="box-items">    
                                ...
                                <div class="box-item-right">
                                    <div class="input-items">
                                        <input type="text" id="username" class="text-input" name="username" value="jihun">
                                        <div class="input-explanation">
                                            <div class="explanation-text1">
                            ...
                            <div class="box-items">    
                                ...
                                <div class="box-item-right">
                                    <div class="input-items">
                                        <textarea id="introduce" class="text-textarea" name="introduce" value=""></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="box-items">    
                                ...
                                <div class="box-item-right">
                                    <div class="input-items">
                                        <input type="text" id="email" class="text-input" name="email" value="2001lion@naver.com">
                                    </div>
                                </div>
                            </div>
                            <div class="box-items">    
                                ...
                                <div class="box-item-right">
                                    <div class="input-items">
                                        <input type="text" id="phone" class="text-input" name="phone" value="+82 010-2434-9616">
